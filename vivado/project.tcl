...
#
# project.tcl: Tcl script for re-creating project 'vivado'
#
# Generated by Vivado on Sun May 14 17:01:49 -0400 2017
...
#
#    "hardware-sort/rtl/sorting_cell.vhd"
#    "hardware-sort/rtl/sort_top.vhd"
#    "hardware-sort/tb/sort_top_tb.vhd"
#    "hardware-sort/tb/sorting_cell_tb.vhd"
#
#*****************************************************************************************
...
set files [list \
 "[file normalize "$origin_dir/../rtl/sorting_cell.vhd"]"\
 "[file normalize "$origin_dir/../rtl/sort_top.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../rtl/sorting_cell.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj

set file "$origin_dir/../rtl/sort_top.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
...
set files [list \
 "[file normalize "$origin_dir/../tb/sort_top_tb.vhd"]"\
 "[file normalize "$origin_dir/../tb/sorting_cell_tb.vhd"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/../tb/sort_top_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj

set file "$origin_dir/../tb/sorting_cell_tb.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
...
set obj [get_filesets sim_1]
set_property "top" "sort_top_tb" $obj
